...
import com.mx.testvideo.Constants
import com.mx.testvideo.R
import com.mx.testvideo.base.BaseActivity
import com.mx.testvideo.glide.GlideApp
import com.mx.testvideo.mvp.contract.VideoDetailContract
import com.mx.testvideo.mvp.model.bean.HomeBean
import com.mx.testvideo.mvp.presenter.VideoDetailPresenter
import com.mx.testvideo.showToast
import com.mx.testvideo.ui.adapter.VideoDetailAdapter
import com.mx.testvideo.ui.view.VideoListener
import com.mx.testvideo.util.CleanLeakUtils
import com.mx.testvideo.util.StatusBarUtil
import com.mx.testvideo.util.WatchHistoryUtils
...
//                Logger.d("***** onQuitFullscreen **** ")
    ...
    private fun saveWatchVideoHistoryInfo(watchItem: HomeBean.Issue.Item) {
        ...
        val historyMap = WatchHistoryUtils.getAll(Constants.FILE_WATCH_HISTORY_NAME, App.context) as Map<*, *>
        for ((key, _) in historyMap) {
            if (watchItem == WatchHistoryUtils.getObject(
                ...
                WatchHistoryUtils.remove(Constants.FILE_WATCH_HISTORY_NAME, App.context, key)
            }
        }
